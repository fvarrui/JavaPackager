...
public class GradlePackageTask extends PackageTask implements TaskInternal, DynamicObjectAware, Task, PackagerFactory {
    private final Project gradleProject = Context.getGradleContext().getProject();
    private List<File> outputFiles;

    public GradlePackageTask() {

        // AbstractTask.class start
        TaskInfo taskInfo = NEXT_INSTANCE.get();
        if (taskInfo == null) {
        ...
        this.outputDirectory = gradleProject.getBuildDir();
        this.description = gradleProject.getDescription();
        this.appName = gradleProject.getName();
        this.appDisplayName = gradleProject.getName();
        this.version = gradleProject.getVersion().toString();
        this.description = gradleProject.getDescription();
        this.organizationName = null;
        this.organizationUrl = null;
        this.assetsDir = new File(gradleProject.getProjectDir(), "assets");
    }
    ...
    private AndSpec<Task> createNewOnlyIfSpec() {
        return new AndSpec<Task>(element -> element == this && enabled);
    }
    ...
    public List<ResourceLock> getSharedResources() {
        ...
        com.google.common.collect.ImmutableList.Builder<ResourceLock> locks = ImmutableList.builder();
